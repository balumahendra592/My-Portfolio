...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Bala Murali Krishna Regeti',
      ...
      builder:(BuildContext context, Widget? child) => AppView(
        child: child,
      ),
      // home:kIsWeb?Scaffold(
      //   backgroundColor: Colors.white,
      //   body: Column(
      //     children: [
      //       NavigationBar(),
      //       Expanded(child:HomeSreen())
      //     ],
      //   ),
      // ):MyHomePage(title: 'Regeti Bala Murali Krishna')
    );
  }
}
